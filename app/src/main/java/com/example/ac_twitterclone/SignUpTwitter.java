...
public class SignUpTwitter extends AppCompatActivity implements View.OnClickListener{
    ...
    public void fnSignUp() {
        ...
        appUser.signUpInBackground(new SignUpCallback() {
            ...
            public void done(ParseException e) {
                if (e == null){
                    FancyToast.makeText(SignUpTwitter.this, appUser.getUsername() + " sing up successfully!", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, true).show();
                    transitionToSocialMediaActivity();
...
//                            startActivity(intent);
    ...
    public void fnErrorMsg(){
        FancyToast.makeText(SignUpTwitter.this, "ERROR", FancyToast.LENGTH_LONG, FancyToast.ERROR, true).show();
    }

    public void fnLogInSwitch() {
        Intent intent = new Intent(SignUpTwitter.this, LogInTwitter.class);
        startActivity(intent);
    }

    private void transitionToSocialMediaActivity(){

        Intent intent = new Intent(SignUpTwitter.this, TwitterUsers.class);
        startActivity(intent);
    }
}